          ...
          <el-col :span="24">
            ...
            <div class="postInfo-container">
              ...
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label-width="120px" label="图标:" class="postInfo-container-item">
                ...
                <el-col :span="6">
                  <el-form-item label-width="90px" label="标签:" class="postInfo-container-item">
                    <el-tag v-for="(tag,index) in formData.tags" :key="index" :disable-transitions="false" closable
